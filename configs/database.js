...
module.exports = {
  ...
  development: {
    ...
    password: process.env.DATABASE_PASSWORD || "fpUmMbAeFCLctQVmpCmXRWyoghnOcyxK",
    database: process.env.DATABASE_NAME || "railway",
    host: process.env.DATABASE_HOST || "crossover.proxy.rlwy.net",
    port: process.env.DATABASE_PORT || 53782,
    dialect: "mysql",
    dialectOptions: {
